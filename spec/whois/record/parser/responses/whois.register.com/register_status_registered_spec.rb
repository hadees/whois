...
#
#   /spec/fixtures/responses/whois.register.com/register_status_registered.expected
#
...
describe Whois::Record::Parser::WhoisRegisterCom, "register_status_registered.expected" do

  before(:each) do
    file = fixture("responses", "whois.register.com/register_status_registered.txt")
